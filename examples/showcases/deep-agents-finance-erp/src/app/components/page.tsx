...
const TOOL_REGISTRY: ToolMeta[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: "totalCash", type: "number", required: true, description: "Total cash and cash equivalents" },
      { name: "totalLiabilities", type: "number", required: true, description: "Total liabilities" },
      {
        name: "netPosition",
        type: "number",
        required: true,
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: "totalAmount", type: "number", required: true, description: "Sum of all invoice amounts" },
      {
        name: "action",
        type: "string",
        required: true,
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: "estimatedTotal", type: "number", required: true, description: "Total estimated cost of the purchase order" },
      { name: "supplier", type: "string", required: false, description: "Supplier name, if known" },
    ],
  },
  ...
  // ---- Dashboard widgets ----
  {
    ...
    parameters: [
      ...
      { name: "colSpan", type: "1 | 2 | 3 | 4", required: false, description: "Grid column span. Default: 4 (full width)" },
    ],
  },
  {
    ...
    colSpan: 2,
    parameters: [
      { name: "showProfit", type: "boolean", required: false, description: "Show the profit line. Default: true" },
      { name: "showExpenses", type: "boolean", required: false, description: "Show the expenses line. Default: true" },
      { name: "colSpan", type: "1 | 2 | 3 | 4", required: false, description: "Grid column span. Default: 3" },
    ],
  },
  {
    ...
    parameters: [
      ...
      { name: "colSpan", type: "1 | 2 | 3 | 4", required: false, description: "Grid column span. Default: 1" },
    ],
  },
  {
    ...
    colSpan: 2,
    parameters: [
      { name: "limit", type: "number (1-20)", required: false, description: "Number of transactions to display. Default: 5" },
      { name: "colSpan", type: "1 | 2 | 3 | 4", required: false, description: "Grid column span. Default: 2" },
    ],
  },
  {
    id: "render_invoices",
  ...
  },
  {
    ...
    colSpan: 2,
    parameters: [
      { name: "title", type: "string", required: true, description: "Chart title displayed on the dashboard card" },
      {
        name: "chartType",
        type: '"area" | "bar" | "line"',
        required: true,
  ...
  // ---- Management tools ----
  {
    ...
    colSpan: 1,
    parameters: [
      { name: "widgetId", type: "string", required: true, description: "The ID of the widget to remove" },
    ],
  },
  {
...
function BentoPreview({ toolId }: { toolId: string }) {
  switch (toolId) {
    ...
    case "render_transactions":
      return (
        <WidgetRenderer
          widget={{ id: "demo-txn", type: "recent-transactions", colSpan: 4, order: 0, config: { limit: 3 } }}
        />
      );
    case "render_invoices":
      return (
        <WidgetRenderer
          widget={{ id: "demo-inv", type: "outstanding-invoices", colSpan: 4, order: 0, config: {} }}
        />
      );
            ...
            {tool.parameters.length === 0 ? (
              ...
              tool.parameters.map((p) => (
                <div key={p.name} className="flex items-center gap-2">
                  ...
                  {p.required && (
                    <Badge variant="default" className="text-[9px] px-1 py-0">req</Badge>
                  )}
                </div>
              ))
            )}
