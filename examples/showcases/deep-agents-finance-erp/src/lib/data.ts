...
export const invoices: Invoice[] = [
  ...
  },
  {
    ...
    dueDate: "2026-04-05",
    items: [
      { description: "API Integration", quantity: 25, unitPrice: 750 },
    ],
  },
  {
    id: "inv-005",
  ...
  },
  {
    ...
    dueDate: "2026-04-28",
    items: [
      { description: "ERP Implementation Phase 2", quantity: 1, unitPrice: 98000 },
  ...
  },
  {
    ...
    dueDate: "2026-03-20",
    items: [
      { description: "Cloud Infrastructure Setup", quantity: 1, unitPrice: 42000 },
...
export const accounts: Account[] = [
  ...
  { id: "acc-006", name: "Short-term Loans", type: "liability", balance: 150000, currency: "USD", code: "2100" },
  { id: "acc-007", name: "Long-term Debt", type: "liability", balance: 520000, currency: "USD", code: "2500" },
  { id: "acc-008", name: "Owner's Equity", type: "equity", balance: 1850000, currency: "USD", code: "3000" },
  { id: "acc-009", name: "Retained Earnings", type: "equity", balance: 642100, currency: "USD", code: "3100" },
  { id: "acc-010", name: "Service Revenue", type: "revenue", balance: 2847350, currency: "USD", code: "4000" },
  { id: "acc-011", name: "Payroll Expense", type: "expense", balance: 580000, currency: "USD", code: "5000" },
  { id: "acc-012", name: "Operating Expense", type: "expense", balance: 625250, currency: "USD", code: "5100" },
];

export const transactions: Transaction[] = [
  { id: "txn-001", date: "2026-03-31", description: "Acme Corp - Invoice Payment", amount: 45000, type: "credit", category: "Revenue", accountCode: "4000", status: "completed" },
  { id: "txn-002", date: "2026-03-30", description: "AWS Infrastructure", amount: 8420, type: "debit", category: "Infrastructure", accountCode: "5100", status: "completed" },
  { id: "txn-003", date: "2026-03-29", description: "Payroll - March Cycle", amount: 48500, type: "debit", category: "Payroll", accountCode: "5000", status: "completed" },
  { id: "txn-004", date: "2026-03-28", description: "Stark Industries - Payment", amount: 56300, type: "credit", category: "Revenue", accountCode: "4000", status: "completed" },
  { id: "txn-005", date: "2026-03-27", description: "Office Supplies", amount: 2340, type: "debit", category: "Operations", accountCode: "5100", status: "completed" },
  { id: "txn-006", date: "2026-03-26", description: "Google Ads Campaign", amount: 12500, type: "debit", category: "Marketing", accountCode: "5100", status: "pending" },
  { id: "txn-007", date: "2026-03-25", description: "Massive Dynamic - Payment", amount: 18750, type: "credit", category: "Revenue", accountCode: "4000", status: "completed" },
...
export const inventoryItems: InventoryItem[] = [
  { id: "item-001", sku: "HW-SRV-001", name: "Dell PowerEdge R750", category: "Servers", quantity: 12, reorderLevel: 5, unitCost: 8500, location: "Warehouse A", status: "in-stock" },
  { id: "item-002", sku: "HW-LAP-001", name: 'MacBook Pro 16"', category: "Laptops", quantity: 3, reorderLevel: 10, unitCost: 2499, location: "Warehouse B", status: "low-stock" },
  { id: "item-003", sku: "HW-MON-001", name: "LG UltraFine 5K", category: "Monitors", quantity: 28, reorderLevel: 15, unitCost: 1299, location: "Warehouse A", status: "in-stock" },
  { id: "item-004", sku: "SW-LIC-001", name: "Microsoft 365 E5 License", category: "Software", quantity: 150, reorderLevel: 50, unitCost: 57, location: "Digital", status: "in-stock" },
  { id: "item-005", sku: "HW-NET-001", name: "Cisco Catalyst 9300", category: "Networking", quantity: 0, reorderLevel: 3, unitCost: 4200, location: "Warehouse A", status: "out-of-stock" },
  { id: "item-006", sku: "HW-LAP-002", name: "ThinkPad X1 Carbon", category: "Laptops", quantity: 8, reorderLevel: 10, unitCost: 1849, location: "Warehouse B", status: "low-stock" },
  { id: "item-007", sku: "HW-STO-001", name: "Synology DS1621+", category: "Storage", quantity: 6, reorderLevel: 3, unitCost: 1099, location: "Warehouse A", status: "in-stock" },
  { id: "item-008", sku: "SW-SEC-001", name: "CrowdStrike Falcon", category: "Software", quantity: 200, reorderLevel: 100, unitCost: 25, location: "Digital", status: "in-stock" },
];

export const employees: Employee[] = [
  { id: "emp-001", name: "Sarah Chen", email: "sarah.chen@company.com", role: "CFO", department: "Finance", startDate: "2020-03-15", status: "active", salary: 195000, avatar: "SC" },
  { id: "emp-002", name: "Marcus Williams", email: "m.williams@company.com", role: "VP Engineering", department: "Engineering", startDate: "2019-08-01", status: "active", salary: 185000, avatar: "MW" },
  { id: "emp-003", name: "Priya Patel", email: "p.patel@company.com", role: "Head of Product", department: "Product", startDate: "2021-01-10", status: "active", salary: 172000, avatar: "PP" },
  { id: "emp-004", name: "James Rodriguez", email: "j.rodriguez@company.com", role: "Senior Developer", department: "Engineering", startDate: "2021-06-20", status: "active", salary: 145000, avatar: "JR" },
  { id: "emp-005", name: "Emily Thompson", email: "e.thompson@company.com", role: "HR Director", department: "Human Resources", startDate: "2020-11-05", status: "active", salary: 158000, avatar: "ET" },
  { id: "emp-006", name: "David Kim", email: "d.kim@company.com", role: "Financial Analyst", department: "Finance", startDate: "2022-02-14", status: "on-leave", salary: 95000, avatar: "DK" },
  { id: "emp-007", name: "Lisa Nakamura", email: "l.nakamura@company.com", role: "Marketing Manager", department: "Marketing", startDate: "2021-09-01", status: "active", salary: 118000, avatar: "LN" },
